        ...
        {FILTERS.map((f) => (
          <button
            ...
            style={{
              background: "none",
              border: "none",
              borderBottom: filter === f.value ? `2px solid ${ACCENT}` : "2px solid transparent",
              marginBottom: -1,
              padding: "10px 20px",
              fontFamily: MONO,
              fontSize: 12,
              color: filter === f.value ? ACCENT : "#6B6B6B",
              cursor: "pointer",
              letterSpacing: "0.1em",
            }}
          >
        ...
        {filtered.map((item) => {
          ...
          return (
            <div key={item.id} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <button
                onClick={() => exportItem(item, item.id - 1)}
                style={{
                  background: "none",

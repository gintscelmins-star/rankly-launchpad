...
const projects = [
  { bg: "#1a1a2e", tag: "Zobārstniecība", name: "iDental Rīga", desc: "Moderns klīnikas dizains ar online rezervāciju" },
  { bg: "#0d1f12", tag: "Enerģētika", name: "Sovereign Solar", desc: "Lead-gen lapa saules paneļu montāžai" },
  { bg: "#1f1a0d", tag: "Autoserviss", name: "Auto Masters Rīga", desc: "Lokāla SEO optimizēta lapa ar CTA" },
  { bg: "#1a0d1a", tag: "Mēbeles", name: "Iebūvējamās Virtuves", desc: "E-com tipa kataloga lapa ar kalkulatoru" },
];
